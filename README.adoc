= SolarView Fronius
Docker image for the SolarView proxy fronius-fb

== Description
This project contains the configuration to build a Docker image for the http://www.solarview.info/solarview_fronius.aspx[SolarView proxy fronius-fb] with GitLab CI.
...
== References
* http://www.solarview.info/solarview_fronius.aspx[SolarView proxy fronius-fb]
